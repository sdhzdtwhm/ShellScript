...
mkdir -p $baseDir
#增量备份
/usr/bin/innobackupex --defaults-file=/etc/my.cnf --host=127.0.0.1 --user=root --password=mvtech123 --incremental $baseDir --no-timestamp --incremental-basedir=$lastDir --parallel=8 --throttle=800
